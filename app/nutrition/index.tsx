  ...
  if(isFetching){
    return(
      <View style={styles.loading}>
        ...
        <Text style={styles.loadingText}>Consultando IA <Ionicons name="globe-outline" size={16} color="#FFF" /></Text>
      </View>
    )
  }
  ...
  if(error){
    return(
      <View style={styles.loading}>
        ...
        <Link href="/">
          <Text style={styles.loadingText}>Tente novamente <Ionicons name="refresh-outline" size={16} color="#000" /></Text>
        </Link>
      </View>
    )
  }  
    ...
    <View style={styles.containerHeader}>
      <View style={styles.contentHeader}>
        ...
        <Pressable style={styles.buttonShare} onPress={handleShare}>
          <Text style={styles.buttonShareText}>Compartilhar <Ionicons name="share-social-outline" size={17} color="#FFF" /></Text>
        </Pressable>
      </View>
    </View>
      ...
      {data && Object.keys(data).length > 0 && (
        <>
          ...
          <ScrollView>
            ...
            <Text style={{fontSize: 17, fontFamily: 'Roboto', paddingHorizontal: 20, paddingVertical: 20, textAlign: 'center', color: colors.white}}>
              * Todas as dietas são montadas com IA + parcerias com nutricionistas.
            </Text>

            <Pressable style={styles.button} onPress={ () => router.replace("/") }>
              <Text style={styles.buttonText}>
                Gerar nova dieta <Ionicons name="restaurant" size={17} color="#FFF" />
              </Text>
            </Pressable>
          </ScrollView>
